  ...
  return (
    <div className="relative flex min-h-screen w-full flex-col items-center justify-center overflow-hidden bg-black">
      ...
      <div className="relative border border-[#27272a] p-2 w-full mx-auto max-w-3xl">
        <main className="relative border border-[#27272a] py-10 overflow-hidden bg-black/50 backdrop-blur-sm">
          ...
          <div className="flex justify-center"> 
              <LiquidButton className="text-white border-white/20 border rounded-full" size={'xl'}>Let&apos;s Go</LiquidButton> 
          </div> 
        </main>
      </div>
    </div>
